...
# This module contains controllers related to user management.
...
module Users
  ...
  class RegistrationsController < Devise::RegistrationsController
    ...
    def configure_account_update_params
      devise_parameter_sanitizer.permit(:account_update, keys: %i[username bio avatar])
    end
    ...
    def update_resource(resource, params)
      ...
      # You can remove or modify this depending on your needs.
